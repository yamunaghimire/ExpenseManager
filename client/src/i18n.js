...
i18n
  ...
  translation: {
    ...
    your_set_budgets: "Your Set Budgets",
    edit: "Edit",
    total_monthly_budget: "Total Monthly Budget",
    no_budgets_set: "No budgets set for this month.",
    my_receipts: "My Receipts",
    search_placeholder: "Search by date, vendor, or item name...",
    ...
    could_not_load_spending: "Could not load spending data.",
...
ne: {
  translation: {
    ...
    budget_breakdown: "बजेट विवरण",
    loading_budgets: "बजेटहरू लोड हुँदैछन्...",
    your_set_budgets: "तपाईंले सेट गर्नुभएको बजेटहरू",
    edit: "सम्पादन",
    total_monthly_budget: "कुल मासिक बजेट",
    no_budgets_set: "यो महिनाका लागि कुनै बजेट सेट गरिएको छैन।",
    my_receipts: "मेरो रसिदहरू",
    search_placeholder: "मिति, विक्रेता वा वस्तुको नामबाट खोज्नुहोस्...",
    no_results_found: "कुनै नतिजा फेला परेन।",
    manual_entry: "म्यानुअल प्रविष्टि",
    bill_no: "बिल नम्बर",
    store: "पसल",
    select_store: "पसल छान्नुहोस्",
    grocery: "खाद्यान्न",
    pharmacy: "औषधि पसल",
    update_item: "वस्तु अपडेट गर्नुहोस्",
    added_items: "थपिएका वस्तुहरू:",
    save_receipt: "रसिद सेभ गर्नुहोस्",
    youve_spent: "तपाईंले खर्च गर्नुभएको",
    could_not_load_spending: "खर्च डेटा लोड हुन सकेन।",
    upload_receipt: "रसिद अपलोड गर्नुहोस्",
    scan_receipt: "रसिद स्क्यान गर्नुहोस्",
    input_text: "पाठ प्रविष्टि",
